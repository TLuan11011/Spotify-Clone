  ...
  return <div className="space-y-8">
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {recentlyPlayed.map(song => <div key={song.id} className="bg-gray-50 rounded-lg p-4 transition-all hover:bg-gray-100" onClick={() => handlePlaySong(song)}>
              <div className="relative group">
                <img src={song.cover} alt={song.title} className="w-full aspect-square object-cover rounded-md mb-3" />
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {recommendedPlaylists.map(playlist => <div key={playlist.id} className="bg-gray-50 rounded-lg overflow-hidden">
              <img src={playlist.cover} alt={playlist.title} className="w-full h-32 object-cover" />
              <div className="p-4">
